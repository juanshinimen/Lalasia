...
namespace Lalasia.Controllers
{
    public class FurnituresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Type,Description,Prices")] Furniture furniture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Type,Description,Prices")] Furniture furniture)
        {
            if (ModelState.IsValid)
            {
